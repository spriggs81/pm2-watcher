...
app.setApp = (obj) => {
   ...
   const failedDelays = typeof(Number(obj.port)) == 'number' && Number(obj.failedDelays) > 0 ? Number(obj.failedDelays) : 300;
   const passedDelays = typeof(Number(obj.passedDelays)) == 'number' && Number(obj.passedDelays) > 0 ? Number(obj.passedDelays) : 300;
